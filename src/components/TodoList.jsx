...
function TodoList() {
  ...
  return (
    <div className="todo-list w-4/5 max-w-lg text-white flex flex-col justify-center m-auto relative bottom-28 rounded-md text-sm md:text-lg">
      {l}
      <div className="flex justify-between p-5">
        ...
        <p
          className="hover:opacity-100 opacity-50 cursor-pointer ml-2"
          onClick={clear}
        >
          Clear Completed
        </p>
